...
public class QuickSideBarView extends View {
  ...
  private void init(Context context, AttributeSet attrs) {
    ...
    mTextSizeChoose =
        context.getResources().getDimensionPixelSize(R.dimen.textSize_quicksidebar_choose);
    ...
    if (attrs != null) {
      ...
      mTextColorChoose =
          a.getColor(R.styleable.QuickSideBarView_sidebarTextColorChoose, mTextColorChoose);
      mTextSize = a.getDimension(R.styleable.QuickSideBarView_sidebarTextSize, mTextSize);
      mTextSizeChoose =
          a.getDimension(R.styleable.QuickSideBarView_sidebarTextSizeChoose, mTextSizeChoose);
        ...
        if (oldChoose != newChoose) {
          if (newChoose >= 0 && newChoose < mLetters.size()) {
            ...
            if (listener != null) {
              ...
              float yPos =
                  mItemHeight * mChoose + (int) ((mItemHeight - rect.height()) * 0.5) + mItemStartY;
